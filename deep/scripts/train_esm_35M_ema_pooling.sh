...
PARAMS=(
  "--config.model.learned_pooling=True"
  "--config.model.all_layers=True"
  "--config.model.learned_pooling=True --config.model.all_layers=True"
  "--config.training.ema_beta=0.9999"
)
