...
```python
filter_out(train_sequences: list[str], metadata: list[Any], ref_sequences: list[str], threshold: float = 0.6, encoder_batch_size: int = 512, aligner_batch_size: int = 0, force_cpu: bool = True) -> tuple:
```
